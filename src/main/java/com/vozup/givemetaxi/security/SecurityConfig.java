...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                //requests matched against require a user to be authenticated and must be associated to the ADMIN role
                //.antMatchers("/pages/admin/**").hasRole("ADMIN")
                //requests matched against require a user to be authenticated and must be associated to the USER role
                //.antMatchers("/pages/operator/**").hasRole("USER")
